...
public class RectangleDetector {
    ...
    public RectangleDetector(ILogger logger, IView view) {
        this.logger = logger;
        this.view = view;
    }

    public  Mat detectRect(Mat src) {
    ...
    private  Mat changePerspective(List<Point> corners, Mat dst) {
        Point p1, p2, p3, p4;
...
//        Core.flip(proj, proj, 1);
    ...
    @Nullable
    private MatOfPoint findCountours(Mat src) {
